...
def get_feishu_app_secret() -> str:
    """Get Feishu app secret from environment."""
    return os.getenv("FEISHU_APP_SECRET", "")

def is_feishu_configured() -> bool:
    """Check if Feishu app credentials are configured for private messaging."""
    return bool(get_feishu_app_id() and get_feishu_app_secret())
